...
my_dir = "examples"
images = [f for f in listdir(my_dir) if isfile(join(my_dir, f))]

for path_name in images:
    print("---------->", f"examples/{path_name}")
    # path_name = sys.argv[1]
    image = cv2.imread(f"examples/{path_name}")
    file_name = os.path.basename(f"examples/{path_name}")
